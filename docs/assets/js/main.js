(function ($) {
  ...
  const top_offset = $(".navigation-menu--onepage").height() - 60;
  $(".navigation-menu--onepage ul").onePageNav({
    currentClass: "active",
    scrollOffset: top_offset,
  });

  const top_offset_mobile = $(".header-area").height();
  ...
  if ($(".has-children--multilevel-submenu").find(".submenu").length) {
    const elm = $(".has-children--multilevel-submenu").find(".submenu");

    elm.each(function () {
      const off = $(this).offset();
      const l = off.left;
      const w = $(this).width();
      const docH = windows.height();
      const docW = windows.width() - 10;
  ...
  const curpage = cururl.substr(cururl.lastIndexOf("/") + 1);
  ...
  /*= ============================================
    ...
    ============================================= */
  const $offCanvasNav = $(".offcanvas-navigation");
  ...
  $(".masonry-activation").imagesLoaded(function () {
    // init Isotope
    const $grid = $(".masonry-wrap").isotope({
  ...
  $(document).ready(function () {
    ...
    const brandLogoSlider = new Swiper(".brand-logo-slider__container", {
      slidesPerView: 6,
      loop: true,
      speed: 1000,
      spaceBetween: 30,
    ...
    const mySwiper = new Swiper(".auto--pree-mode-flexible__container", {
      spaceBetween: 30,
      loop: true,
      freeMode: true,
      slidesPerView: "auto",
  ...
  if ($("#fullpage").length) {
    $("#fullpage").fullpage({
      ...
      afterLoad () {
        const activeSetion = $(`.fp-viewing-${  3}`);
  ...
  if (activeId2.length) {
    const userID_one = activeId2.attr("data-userid_one");
      const accessTokenID2 = activeId2.attr("data-accesstoken2");
      const userFeed2 = new Instafeed({
        get: "user",
        userId: userID_one,
        target: "instafeed",
  ...
  /* ==================================
    =          Option Demo              =
    ===================================== */
  const $demoOption = $(".demo-option-container");
  ...
  /*= ==================================
        Svg Icon Draw
    ==================================== */
  const $svgIconBox = $(".single-svg-icon-box");
  $svgIconBox.each(function () {
    const $this = $(this);
      const $svgIcon = $this.find(".svg-icon");
      const $id = $svgIcon.attr("id");
      const $icon = $svgIcon.data("svg-icon");
    const $vivus = new Vivus($id, { duration: 100, file: $icon });
  ...
  $(".slide-scroll-bg")
    ...
    .scrollie({
      scrollOffset: 0,
      scrollingInView (elem) {
        console.log(elem);
        const bgColor = elem.data("background");
  ...
  const revealId = $(".reveal-footer");
    const heightFooter = revealId.outerHeight();
