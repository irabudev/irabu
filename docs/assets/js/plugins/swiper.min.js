...
!(function (e, t) {
  ...
  const t = {
    ...
    attr (e, t) {
      ...
      for (let i = 0; i < this.length; i += 1)
        if (a.length === 2) this[i].setAttribute(e, t);
        else
    ...
    offset () {
      if (this.length > 0) {
        const e = this[0];
          ...
          const a = f.body;
          const i = e.clientTop || a.clientTop || 0;
          const s = e.clientLeft || a.clientLeft || 0;
          const r = e === J ? J.scrollY : e.scrollTop;
          const n = e === J ? J.scrollX : e.scrollLeft;
    ...
    children (e) {
      for (var t = [], a = 0; a < this.length; a += 1)
        for (let i = this[a].childNodes, s = 0; s < i.length; s += 1)
          e
            ? i[s].nodeType === 1 && L(i[s]).is(e) && t.push(i[s])
            : i[s].nodeType === 1 && t.push(i[s]);
      return new l(r(t));
    },
    remove () {
  ...
  let e;
          ...
          J.WebKitCSSMatrix
            ? ((i = r.transform || r.webkitTransform).split(",").length > 6 &&
                (i = i
                  ...
                  .join(", ")),
              (s = new J.WebKitCSSMatrix(i === "none" ? "" : i)))
            : (a = (s =
                r.MozTransform ||
                r.OTransform ||
                r.MsTransform ||
        ...
        for (var a = Object(e[0]), i = 1; i < e.length; i += 1) {
          ...
          if (s != null)
            for (
              ...
              const l = r[n];
                const d = Object.getOwnPropertyDescriptor(s, l);
              void 0 !== d &&
                d.enumerable &&
    ...
    const te =
      ((i = f.createElement("div")),
      {
        ...
        pointerEvents: !!(
          ...
          J.PointerEvent ||
          ("maxTouchPoints" in J.navigator && J.navigator.maxTouchPoints > 0)
        ),
    ...
    const o = { components: { configurable: !0 } };
  ...
  const d = {
    ...
    updateSlides () {
      const e = this;
        ...
        const r = e.wrongRTL;
        const n = e.virtual && t.virtual.enabled;
        const o = n ? e.virtual.slides.length : e.slides.length;
        const l = a.children(`.${  e.params.slideClass}`);
        const d = n ? e.virtual.slides.length : l.length;
        let p = [];
        const c = [];
        const u = [];
        ...
        for (
          ...
          if (P.css("display") !== "none") {
            if (t.slidesPerView === "auto") {
              const I = J.getComputedStyle(P[0], null);
                const D = P[0].style.transform;
                const O = P[0].style.webkitTransform;
              if (
                ...
                const A = parseFloat(I.getPropertyValue("width"));
                  const H = parseFloat(I.getPropertyValue("padding-left"));
                  const N = parseFloat(I.getPropertyValue("padding-right"));
                  const G = parseFloat(I.getPropertyValue("margin-left"));
                  const B = parseFloat(I.getPropertyValue("margin-right"));
                  const X = I.getPropertyValue("box-sizing");
                T = X && X === "border-box" ? A + G + B : A + H + N + G + B;
              } else {
                const Y = parseFloat(I.getPropertyValue("height"));
                  const V = parseFloat(I.getPropertyValue("padding-top"));
                  const F = parseFloat(I.getPropertyValue("padding-bottom"));
                  const R = parseFloat(I.getPropertyValue("margin-top"));
                  const q = parseFloat(I.getPropertyValue("margin-bottom"));
                  const W = I.getPropertyValue("box-sizing");
    ...
    updateClickedSlide (e) {
      const t = this;
        const a = t.params;
        const i = L(e.target).closest(`.${  a.slideClass}`)[0];
        let s = !1;
      if (i)
  ...
  const c = {
    ...
    transitionEnd (e, t) {
      ...
      if (
        ...
        if (r === "reset") return void a.emit("slideResetTransitionEnd");
  ...
  const u = {
    slideTo (e, t, a, i) {
      ...
      const n = s.params;
        ...
        const p = s.activeIndex;
        const c = s.rtlTranslate;
      ...
      return (
        ...
        (c && -v === s.translate) || (!c && v === s.translate)
          ? (s.updateActiveIndex(r),
            ...
            n.effect !== "slide" && s.setTranslate(v),
            h !== "reset" && (s.transitionStart(a, h), s.transitionEnd(a, h)),
            !1)
          : (t !== 0 && te.transition
              ? (s.setTransition(t),
                s.setTranslate(v),
  ...
  const h = {
    loopCreate () {
      ...
      if (e.loopFillGroupWithBlank) {
        const a = e.slidesPerGroup - (s.length % e.slidesPerGroup);
        if (a !== e.slidesPerGroup) {
          for (let r = 0; r < a; r += 1) {
            const n = L(f.createElement("div")).addClass(
    ...
    loopFix () {
      ...
      i < r
        ...
        : ((a.slidesPerView === "auto" && 2 * r <= i) || i >= s.length - r) &&
          ((e = -s.length + i + r),
          (e += r),
          t.slideTo(e, 0, !1, !0) &&
            p !== 0 &&
  ...
  const m = {
    ...
    const g = (function () {
      const e = J.navigator.userAgent;
        ...
        const a = e.match(/(Windows Phone);?[\s\/]+([\d.]+)?/);
        const i = e.match(/(Android);?[\s\/]+([\d.]+)?/);
        const s = e.match(/(iPad).*OS\s([\d_]+)/);
        const r = e.match(/(iPod)(.*OS\s([\d_]+))?/);
        const n = !s && e.match(/(iPhone\sOS|iOS)\s([\d_]+)/);
      if (
        ...
        t.ios &&
          t.osVersion &&
          e.indexOf("Version/") >= 0 &&
          t.osVersion.split(".")[0] === "10" &&
          (t.osVersion = e.toLowerCase().split("version/")[1].split(" ")[0]),
        (t.desktop = !(t.os || t.android || t.webView)),
        (t.webView = (n || s || r) && e.match(/.*AppleWebKit(?!.*Safari)/i)),
        t.os && t.os === "ios")
      ) {
        const o = t.osVersion.split(".");
          const l = f.querySelector('meta[name="viewport"]');
        t.minimalUi =
          !t.webView &&
          (r || n) &&
  ...
  const w = {
    ...
    const y = {
      ...
      events: {
        attachEvents () {
            ...
            if (!t.animating || !i.preventInteractionOnTransition) {
              ...
              if (
                ...
                if (
                  ...
                  const n = s.currentX;
                    const o = s.currentY;
                    const l = i.edgeSwipeDetection || i.iOSEdgeSwipeDetection;
                    const d = i.edgeSwipeThreshold || i.iOSEdgeSwipeThreshold;
          ...
          const r = t.touchEventsTarget === "container" ? i : s;
            const n = !!t.nested;
          ...
          if (r && (!r || Object.keys(r).length !== 0)) {
            ...
            if (n && e.currentBreakpoint !== n) {
              ...
              const l = o || e.originalParams;
                ...
                const p = s.loop && (l.slidesPerView !== s.slidesPerView || d);
    ...
    const T = (function (u) {
      function h() {
        for (var e, t, s, a = [], i = arguments.length; i--; )
          a[i] = arguments[i];
        a.length === 1 && a[0].constructor && a[0].constructor === Object
          ? (s = a[0])
          : ((t = (e = a)[0]), (s = e[1])),
          s || (s = {}),
          (s = ee.extend({}, s)),
        ...
        const o = (r.$ = L)(r.params.el);
        if ((t = o[0])) {
          if (o.length > 1) {
            const l = [];
            return (
              o.each(function (e, t) {
                const a = ee.extend({}, s, { el: t });
                l.push(new h(a));
              }),
              l
            );
          ...
          let d;
            let p;
            const c = o.children(`.${  r.params.wrapperClass}`);
          return (
            ee.extend(r, {
              $el: o,
              el: t,
      ...
      return (
        ...
        (h.prototype.update = function () {
          ...
          function i() {
            const e = a.rtlTranslate ? -1 * a.translate : a.translate;
              const t = Math.min(Math.max(e, a.maxTranslate()), a.minTranslate());
        ...
        (h.prototype.changeDirection = function (a, e) {
          void 0 === e && (e = !0);
          const t = this;
            const i = t.params.direction;
          return (
            a || (a = i === "horizontal" ? "vertical" : "horizontal"),
            a === i ||
    ...
    const E = { name: "device", proto: { device: g }, static: { device: g } };
    const S = { name: "support", proto: { support: te }, static: { support: te } };
    const C = { name: "browser", proto: { browser: I }, static: { browser: I } };
    const M = {
      name: "resize",
      create () {
        const e = this;
    ...
    const k = {
      update (e) {
        const t = this;
          ...
          const o = n.addSlidesBefore;
          const l = n.addSlidesAfter;
          const d = t.virtual;
          const p = d.from;
          const c = d.to;
          const u = d.slides;
        ...
        const y = Math.max((w || 0) - b, 0);
          const x = Math.min((w || 0) + g, u.length - 1);
          const T = (t.slidesGrid[y] || 0) - (t.slidesGrid[0] || 0);
        function E() {
          t.updateSlides(),
            t.updateProgress(),
            t.updateSlidesClasses(),
    ...
    const D = {
      handle (e) {
        const t = this;
          const a = t.rtlTranslate;
          let i = e;
        i.originalEvent && (i = i.originalEvent);
        const s = i.keyCode || i.charCode;
        if (
          !t.allowSlideNext &&
          ((t.isHorizontal() && s === 39) || (t.isVertical() && s === 40))
        )
          return !1;
        if (
          !t.allowSlidePrev &&
          ((t.isHorizontal() && s === 37) || (t.isVertical() && s === 38))
        )
          return !1;
        if (
          !(
          ...
          t.isHorizontal()
            ? ((s !== 37 && s !== 39) ||
              ...
              ((s === 39 && !a) || (s === 37 && a)) && t.slideNext(),
              ((s === 37 && !a) || (s === 39 && a)) && t.slidePrev())
            : ((s !== 38 && s !== 40) ||
                (i.preventDefault ? i.preventDefault() : (i.returnValue = !1)),
              s === 40 && t.slideNext(),
              s === 38 && t.slidePrev()),
  ...
  var A = {
        ...
        J.navigator.userAgent.indexOf("firefox") > -1
          ...
          : (function () {
              ...
              if (!t) {
                ...
                a.setAttribute(e, "return;"), (t = typeof a[e] === "function");
              }
              return (
                !t &&
                  f.implementation &&
          ...
          if (
            (e.params.loop
              ? ((r = Math.ceil(
                ...
                n - 1 < r && (r -= n),
                r < 0 && e.params.paginationType !== "bullets" && (r = n + r))
            ...
            if (s.dynamicBullets) {
              const v = Math.min(p.length, s.dynamicMainBullets + 4);
                const f =
                  (e.pagination.bulletSize * v - e.pagination.bulletSize) / 2 -
                  d * e.pagination.bulletSize;
                const m = t ? "right" : "left";
    ...
    const G = {
      ...
      enableDraggable () {
        ...
        if (e.params.scrollbar.el) {
          const t = e.scrollbar;
            const a = e.touchEventsTouch;
            const i = e.touchEventsDesktop;
            const s = e.params;
            const r = t.$el[0];
            const n = !(!te.passiveListener || !s.passiveListeners) && {
              passive: !1,
              capture: !1,
            };
            const o = !(!te.passiveListener || !s.passiveListeners) && {
              passive: !0,
              capture: !1,
            };
          te.touch
    ...
    const B = {
      setTransform (e, t) {
        ...
        if (l == null) i.transform(`translate3d(${  n  }, ${  o  }, 0px)`);
        else {
    ...
    var X = {
      ...
      onGestureStart (e) {
        ...
        s.$slideEl.length === 0 && (s.$slideEl = t.slides.eq(t.activeIndex)),
      ...
      onGestureEnd (e) {
        ...
        if (!te.gestures) {
          ...
          if (
            e.type !== "touchend" ||
            (e.type === "touchend" && e.changedTouches.length < 2 && !g.android)
          )
            return;
    ...
    const Y = {
            ...
            t.length !== 0 &&
              t.each(function (e, t) {
                ...
                const s = i.attr("data-background");
                  const r = i.attr("data-src");
                  const n = i.attr("data-srcset");
                  const o = i.attr("data-sizes");
                d.loadImage(i[0], r || s, n, o, !1, function () {
                  if (d != null && d && (!d || d.params) && !d.destroyed) {
                    if (
                      ...
                      const e = c.attr("data-swiper-slide-index");
                      if (c.hasClass(d.params.slideDuplicateClass)) {
                        const t = d.$wrapperEl.children(
                          `[data-swiper-slide-index="${ 
                            e 
                            }"]:not(.${ 
      ...
      load () {
        const i = this;
          ...
          const r = i.virtual && a.virtual.enabled;
          const n = a.lazy;
        ...
        if (
          ...
          t.children(`.${  a.slideVisibleClass}`).each(function (e, t) {
            const a = r ? L(t).attr("data-swiper-slide-index") : L(t).index();
            i.lazy.loadInSlide(a);
          });
        else if (o > 1)
          for (let p = e; p < e + o; p += 1) l(p) && i.lazy.loadInSlide(p);
        ...
        if (n.loadPrevNext)
          if (o > 1 || (n.loadPrevNextAmount && n.loadPrevNextAmount > 1)) {
            ...
            for (let m = v; m < e; m += 1) l(m) && i.lazy.loadInSlide(m);
          } else {
            const g = t.children(`.${  a.slideNextClass}`);
            g.length > 0 && i.lazy.loadInSlide(d(g));
            const b = t.children(`.${  a.slidePrevClass}`);
    ...
    const q = {
      onHashCange () {
        const e = this;
          const t = f.location.hash.replace("#", "");
        ...
        if (e.hashNavigation.initialized && e.params.hashNavigation.enabled)
          if (
            ...
            const t = e.slides.eq(e.activeIndex);
              const a = t.attr("data-hash") || t.attr("data-history");
            f.location.hash = a || "";
          }
      },
      init () {
        ...
        if ((t.transition(e), a.params.virtualTranslate && e !== 0)) {
          ...
          t.transitionEnd(function () {
            if (!s && a && !a.destroyed) {
              (s = !0), (a.animating = !1);
              for (
                let e = ["webkitTransitionEnd", "transitionend"], t = 0;
                t < e.length;
                t += 1
              )
                i.trigger(e[t]);
    ...
    const U = {
      setTranslate () {
        let e;
          ...
          const l = t.size;
          const d = t.params.cubeEffect;
          const p = t.isHorizontal();
        ...
        if (
          ...
          if (p)
            ...
            const C = Math.abs(u) - 90 * Math.floor(Math.abs(u) / 90);
              const M =
                1.5 -
                (Math.sin((2 * C * Math.PI) / 360) / 2 +
                  Math.cos((2 * C * Math.PI) / 360) / 2);
              const z = d.shadowScale;
              const P = d.shadowScale / M;
        ...
        const $ = I.isSafari || I.isUiWebView ? -l / 2 : 0;
        i.transform(
          `translate3d(0px,0,${ 
            $ 
            }px) rotateX(${ 
    ...
    const _ = {
      setTranslate () {
        for (
          ...
          const v = i.eq(u);
            const f = r[u];
            const m = ((d - v[0].swiperSlideOffset - f / 2) / f) * n.modifier;
            let g = o ? p * m : 0;
            let b = o ? 0 : p * m;
            let w = -c * Math.abs(m);
      ...
      },
      {
        ...
        create () {
          ...
          Object.defineProperty(i.zoom, "scale", {
            ...
            set (e) {
              if (s !== e) {
                const t = i.zoom.gesture.$imageEl
                    ? i.zoom.gesture.$imageEl[0]
                    : void 0;
                  const a = i.zoom.gesture.$slideEl
