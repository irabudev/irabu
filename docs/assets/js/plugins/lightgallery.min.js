    ...
    (b.prototype.init = function () {
      ...
      (b.prototype.structure = function () {
        ...
        if (
          ...
          this.s.appendSubHtmlTo === ".lg-sub-html" &&
          ...
          const h = this.$outer.find(".lg-inner");
      ...
      (b.prototype.setTop = function () {
        if (this.s.height !== "100%") {
          const b = a(window).height();
            const c = (b - parseInt(this.s.height, 10)) / 2;
            const d = this.$outer.find(".lg");
      ...
      (b.prototype.isVideo = function (a, b) {
        ...
        const d = a.match(
          ...
          const e = a.match(/\/\/(?:www\.)?vimeo.com\/([0-9a-z\-_]+)/i);
          const f = a.match(/\/\/(?:www\.)?dai.ly\/([0-9a-z\-_]+)/i);
          const g = a.match(
      ...
      (b.prototype.loadContent = function (b, c, d) {
        let e;
          ...
          const m = function (b) {
            ...
            for (let h = a(window).width(), i = 0; i < c.length; i++)
        ...
        k.s.dynamic
          ...
          : k.$items.eq(b).attr("data-iframe") === "true" && (n = !0);
        const o = k.isVideo(f, b);
        if (!k.$slide.eq(b).hasClass("lg-loaded")) {
          ...
          this.s.appendSubHtmlTo !== ".lg-sub-html" && k.addHtml(b),
      ...
      (b.prototype.slide = function (b, c, d, e) {
        const f = this.$outer.find(".lg-current").index();
          const g = this;
        if (!g.lGalleryOn || f !== b) {
          const h = this.$slide.length;
            const i = g.lGalleryOn ? this.s.speed : 0;
          if (!g.lgBusy) {
            if (this.s.download) {
              let j;
              (j = g.s.dynamic
                ...
                : g.$items.eq(b).attr("data-download-url") !== "false" &&
      ...
      (b.prototype.keyPress = function () {
        ...
        this.$items.length > 1 &&
          a(window).on("keyup.lg", function (a) {
            b.$items.length > 1 &&
              (a.keyCode === 37 && (a.preventDefault(), b.goToPrevSlide()),
              a.keyCode === 39 && (a.preventDefault(), b.goToNextSlide()));
          }),
      ...
      (b.prototype.touchEnd = function (a) {
        const b = this;
        b.s.mode !== "lg-slide" && b.$outer.addClass("lg-slide"),
          this.$slide
...
(function (root, factory) {
  ...
  (function () {
    ...
    function onAferAppendSlide(event, index) {
      const $videoCont = this.core.$slide.eq(index).find(".lg-video-cont");
  ...
  !(function () {
    ...
    (c.prototype.init = function () {
      ...
      (c.prototype.controls = function () {
        const b = this;
          const c = '<span class="lg-autoplay-button lg-icon"></span>';
...
!(function (a, b) {
  ...
  !(function () {
    ...
    const b = function () {
        let a = !1;
          const b = navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./);
    ...
    (d.prototype.init = function () {
      ...
      b.core.s.actualSize &&
        ...
        b.core.$el.on("onSlideItemLoad.lg.tm.zoom", function (c, d, e) {
          let f = b.core.s.enableZoomAfter + e;
      ...
      let d = 1;
        const e = function (c) {
          let d;
            let e;
            const f = b.core.$outer.find(".lg-current .lg-image");
            const g = (a(window).width() - f.prop("offsetWidth")) / 2;
            const h =
        ...
        const g = function (c, e, g, h) {
          let i;
            const j = e.prop("offsetWidth");
          i = b.core.s.dynamic
      ...
      b.core.$el.on("onAferAppendSlide.lg.tm.zoom", function (a, c) {
        const d = b.core.$slide.eq(c).find(".lg-image");
      ...
      (d.prototype.zoomSwipe = function () {
        ...
        a.core.$slide.on("touchstart.lg", function (c) {
          if (a.core.$outer.hasClass("lg-zoomed")) {
            const d = a.core.$slide.eq(a.core.index).find(".lg-object");
            (f =
          ...
          a.core.$slide.on("touchmove.lg", function (g) {
            if (a.core.$outer.hasClass("lg-zoomed")) {
              let h;
                let i;
                const j = a.core.$slide.eq(a.core.index).find(".lg-img-wrap");
              g.preventDefault(),
                (d = !0),
                (c = {
      ...
      (d.prototype.zoomDrag = function () {
        ...
        b.core.$slide.on("mousedown.lg.zoom", function (d) {
          const f = b.core.$slide.eq(b.core.index).find(".lg-object");
          (h =
          ...
          a(window).on("mousemove.lg.zoom", function (a) {
            if (e) {
              let i;
                let j;
                const k = b.core.$slide.eq(b.core.index).find(".lg-img-wrap");
              (f = !0),
      ...
      (d.prototype.touchendZoom = function (a, b, c, d) {
        const e = this;
          const f = e.core.$slide.eq(e.core.index).find(".lg-img-wrap");
          const g = e.core.$slide.eq(e.core.index).find(".lg-object");
          let h = -Math.abs(f.attr("data-x")) + (b.x - a.x);
          let i = -Math.abs(f.attr("data-y")) + (b.y - a.y);
          const j = (e.core.$outer.find(".lg").height() - g.prop("offsetHeight")) / 2;
          const k = Math.abs(
            g.prop("offsetHeight") * Math.abs(g.attr("data-scale")) -
              e.core.$outer.find(".lg").height() +
              j
          );
          const l = (e.core.$outer.find(".lg").width() - g.prop("offsetWidth")) / 2;
          const m = Math.abs(
    ...
    (c.prototype.init = function () {
      ...
      (c.prototype.getSahreProps = function (a, b) {
        ...
        if (this.core.s.dynamic) c = this.core.s.dynamicEl[a][b];
          ...
          const d = this.core.$items.eq(a).attr("href");
            const e = this.core.$items.eq(a).data(b);
          c = b === "src" ? d || e : e;
        }
        return c;
      }),
